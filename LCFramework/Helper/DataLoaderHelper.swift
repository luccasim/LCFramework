...
public protocol LoaderItemProtocol {
...
public struct LoaderItem : LoaderItemProtocol {
...
open class DataLoader<T:AnyObject> : DataLoaderHelperProtocol {
    ...
    public init(Session:URLSession, Convert: @escaping((Data)->T?)) {
